...
using heARTshop.Repository.Implementation;
using heARTshop.Repository.Interface;
using heARTshop.Services;
using heARTshop.Services.Implementation;
...
namespace heARTshop.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<heARTshopApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
