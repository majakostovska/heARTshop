...
namespace heARTshop.Web.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("ProductName,Image,ProductDescription,ProductArtist,ProductPrice,Rating")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,ProductName,Image,ProductDescription,ProductArtist,ProductPrice,Rating")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
